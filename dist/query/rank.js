 ...
 */
export function rankCandidates(candidates, subjectFile, anchor, weights = RANK_WEIGHTS) {
    ...
    for (const candidate of candidates) {
        ...
        if (key === anchorFileKey)
            continue; // exclude the subject symbol's own file
