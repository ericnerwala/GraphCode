...
export const TOOL_DEFINITIONS = [
    {
        name: 'graph_search',
        description: 'Full-text search over the whole knowledge graph (files, symbols, commits, docs, features). ' +
    ...
    {
        name: 'graph_explore',
        description: 'Expand the graph neighborhood (contains/calls/imports/references/etc.) around one or more ' +
    ...
    {
        name: 'graph_callers',
        description: 'Find everything that calls (or otherwise references) a given symbol, walking the call graph ' +
    ...
    {
        name: 'graph_callees',
        description: 'Find everything a given symbol calls or depends on, walking the call graph up to a depth. ' +
    ...
    {
        name: 'graph_impact',
        description: 'Blast-radius / impact analysis for a symbol or file: everything transitively affected across ' +
    ...
    {
        name: 'graph_context',
        description: 'Build a ranked, token-budgeted context pack (relevant files, symbols, commits, docs, features) ' +
